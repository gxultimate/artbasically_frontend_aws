  ...
  render () {
    ...
    return (
      <div className="btnmodal">
        ...
        <MDBModal isOpen={this.state.modal1} toggle={this.toggle(1)} centered className="modalform">
          <MDBModalHeader toggle={this.toggle(1)}>Artist Registration</MDBModalHeader>
