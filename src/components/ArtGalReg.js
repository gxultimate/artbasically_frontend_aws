						...
						<form onSubmit={this.submitHandler} className="formbtn">
							...
							<MDBInput
								...
								onChange={(accInstitution) =>
									account.setProperty('accInstitution', accInstitution.target.value)}
							>
							...
							<div className="uploadreq clearfix">
								<p className="req">
									Acceptable documents include passport, national ID card (NIC/CNIC), driver's
									license, NBI Clearance (Philippines only), tax ID, voter ID, postal ID, or any other
									valid government-issued photo ID that meets these criteria.
								</p>
							</div>
